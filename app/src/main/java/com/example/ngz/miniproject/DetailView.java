...
public class DetailView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvShowName.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View v) {
                openDialog(adapter.strName[pos], 1);
            }
        });
        tvShowEmail.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View v) {
                openDialog(adapter.email[pos], 2);
            }
        });
        tvShowPhone.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View v) {
    ...
    private void showImgDialog(final CustomAdapter adapter) {
        ShowImgCircle.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View v) {
                final Dialog dialog = new Dialog(DetailView.this);
...
//                photoView.update();
                btDialog.setOnClickListener(new android.view.View.OnClickListener() {
                    @Override
                    public void onClick(android.view.View v) {
                        dialog.dismiss();
                    }
    ...
    public void openDialog(String oldData, final int i) {
        ...
        tvUpdate.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View v) {

                final ProgressDialog progressDialog = new ProgressDialog(DetailView.this);
